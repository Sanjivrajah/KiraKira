-- MyInvois sandbox can return HTTP 202 with a null lower-camel submissionUid
-- when every document fails synchronous validation. Repair rows that the
-- earlier strict response parser classified as an invalid response.
