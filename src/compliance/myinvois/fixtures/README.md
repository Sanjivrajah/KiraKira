...
The Stage 3 mapper covers standard Invoice v1.1 documents and the normal
...
Official contract metadata: MyInvois Invoice v1.1 and code-table pages,
retrieved 2026-07-17, mapper version `invoice-v1.1.1`, JSON/UBL 2.1. Source URLs
