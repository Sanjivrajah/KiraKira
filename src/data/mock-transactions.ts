...
export const mockTransactions: Transaction[] = [
  {
    ...
    createdBy: "user_demo",
    type: "income",
    subtotal: 480, tax: 0, total: 480, currency: "MYR",
    date: "2026-07-14",
    category: "Sales",
    description: "Morning nasi lemak sales",
    counterpartyName: "Walk-in customers",
  ...
  {
    id: "txn_002",
    businessId: "business_demo", createdBy: "user_demo",
    type: "expense",
    subtotal: 86.4, tax: 0, total: 86.4, currency: "MYR",
    date: "2026-07-13",
    category: "Inventory",
    ...
    updatedAt: "2026-07-13T10:30:00.000Z", items: [],
  },
  {
    id: "txn_003",
    businessId: "business_demo", createdBy: "user_demo",
    type: "income",
    subtotal: 850, tax: 0, total: 850, currency: "MYR",
    date: "2026-07-12",
    category: "Catering",
    ...
    updatedAt: "2026-07-12T06:20:00.000Z", items: [],
  },
  {
    id: "txn_004",
    businessId: "business_demo", createdBy: "user_demo",
    type: "expense",
    subtotal: 126.4, tax: 0, total: 126.4, currency: "MYR",
    date: "2026-07-11",
    category: "Supplies",
    description: "Weekly grocery purchase",
    counterpartyName: "Pasar Raya Kita",
    paymentMethod: "Cash",
    sourceType: "voice",
    status: "needs_review",
    createdAt: "2026-07-11T09:10:00.000Z",
    updatedAt: "2026-07-11T09:10:00.000Z", items: [],
  },
  {
    id: "txn_005",
    businessId: "business_demo", createdBy: "user_demo",
    type: "expense",
    subtotal: 78, tax: 0, total: 78, currency: "MYR",
    date: "2026-07-10",
    category: "Utilities",
    ...
    updatedAt: "2026-07-10T02:05:00.000Z", items: [],
  },
  {
    id: "txn_006",
    businessId: "business_demo", createdBy: "user_demo",
    type: "income",
    subtotal: 620, tax: 0, total: 620, currency: "MYR",
    date: "2026-07-09",
    category: "Sales",
    ...
    updatedAt: "2026-07-09T05:15:00.000Z", items: [],
  },
];
