...
function DashboardContent() {
  ...
  return (
    <AppShell>
      <PageHeader eyebrow="Monday, 13 July" title={`Selamat pagi, ${firstName}`} description={`Here’s how ${businessName} is doing today.`} action={<button className="button button-primary" type="button"><Plus aria-hidden="true" size={18} />Add record</button>} />
      ...
      <div className="content-grid">
        <section className="panel activity-panel" aria-labelledby="activity-title">
          <div className="panel-heading"><div><p className="section-kicker">Latest updates</p><h2 id="activity-title">Recent activity</h2></div><button className="text-button" type="button">View all <ArrowUpRight aria-hidden="true" size={16} /></button></div>
